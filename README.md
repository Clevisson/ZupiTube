...
## Recursos_Descrição
>Como produto mínimo viável,foi desenvolvida a funcionalidade de hospedar o video na AWS.<br /> Através da rota http://localhost:9000/storage/uploadVideo, passando o video na request, ele é enviado para um bucket na aws e retornado sua Url que pode acessada para consumo do recurso.<br/>
